document.addEventListener("DOMContentLoaded", function () {
  ...
  // See all tugma
  let see_all__btn = document.querySelector(".see_all__btn");
  let see_all_box = document.querySelector(".see_all_box");

  if (see_all__btn && see_all_box) {
    see_all__btn.addEventListener("click", function () {
      see_all_box.classList.toggle("see_all_box-active");
      see_all__btn.classList.toggle("see_all__btn-active");
    });
  }

  const timerElement = document.querySelector(".bottom_timer");

  if (!timerElement) {
    console.warn("bottom_timer topilmadi");
    return;
  }
